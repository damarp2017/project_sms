...
$countLecturer      = $objLecturer->count();
...
<div class="row">
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-row">
                  <a data-toggle="tooltip" data-original-title="Click for more details" href="?page=user-admin"><div class="round round-lg align-self-center round-info"><i class="icon-people"></i></div></a>
                    <div class="m-l-10 align-self-center">
                        <h3 class="m-b-0 font-light"><?php echo $countAdmin; ?></h3>
                        <h5 class="text-muted m-b-0">Total User Administrator</h5></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-row">
                  <a data-toggle="tooltip" data-original-title="Click for more details" href="?page=user-lecturer"><div class="round round-lg align-self-center round-info"><i class="icon-people"></i></div></a>
                    <div class="m-l-10 align-self-center">
                        <h3 class="m-b-0 font-light"><?php echo $countLecturer; ?></h3>
                        <h5 class="text-muted m-b-0">Total User Lecturer</h5></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-row">
                    <a data-toggle="tooltip" data-original-title="Click for more details" href="?page=user-student"><div class="round round-lg align-self-center round-warning"><i class="icon-graduation"></i></div></a>
                    <div class="m-l-10 align-self-center">
                        <h3 class="m-b-0 font-lgiht"><?php echo $countStudent; ?></h3>
