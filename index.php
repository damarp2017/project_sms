...
<head>
    ...
    <link href="assets/dist/css/colors/green-dark.css" id="theme" rel="stylesheet">
...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(assets/images/background/office_4-wallpaper-2560x1440.jpg);">
            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="login.php" method="post">
                    ...
                    <div class="form-group">
                        <label class="control-label text-right">Level Access</label>
                            <select class="form-control custom-select" name="user">
                                <option value="student">Student</option>
                                <option value="lecturer">Lecturer</option>
                                <option value="admin">Administrator</option>
                            </select>
                            <small class="form-control-feedback text-danger"> Select Your Level Access. </small>
                    </div>
